...
func TestProperties(t *testing.T) {
	...
	tests := []struct {
		...
		{`{"foo":{"type":"string"}, "bar":{"type":"number"}}`, Properties{
			{Name: "foo", Schema: &Schema{Type: Type{"string"}}},
			{Name: "bar", Schema: &Schema{Type: Type{"number"}}},
		}, false},
		// Invalid YAML.
		{`{`, Properties{}, true},
		{`{]`, Properties{}, true},
...
func TestAdditionalProperties(t *testing.T) {
	...
	tests := []struct {
		...
		{`{"type":"string"}`, AdditionalProperties{Schema: Schema{Type: Type{"string"}}}, false},
...
func TestPatternProperties(t *testing.T) {
	...
	tests := []struct {
		...
		{`{"\\w+":{"type":"string"}, "\\d+":{"type":"number"}}`, PatternProperties{
			{Pattern: "\\w+", Schema: &Schema{Type: Type{"string"}}},
			{Pattern: "\\d+", Schema: &Schema{Type: Type{"number"}}},
		}, false},
		// Invalid JSON.
