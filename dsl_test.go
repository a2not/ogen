					...
					Parameters: []*ogen.Parameter{
						{
							...
							Required:    true,
							Schema:      &ogen.Schema{Type: ogen.Type{"integer"}, Format: "int32"},
						},
					},
							...
							Content: map[string]ogen.Media{
								ir.EncodingJSON.String(): {Schema: &ogen.Schema{
									...
									Properties: []ogen.Property{
										{Name: "prop1", Schema: &ogen.Schema{Type: ogen.Type{"integer"}, Format: "int32"}},
										{Name: "prop2", Schema: &ogen.Schema{Type: ogen.Type{"string"}}},
									},
								}},
							},
						},
